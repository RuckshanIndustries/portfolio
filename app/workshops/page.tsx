  ...
  const workshops = [
    {
      ...
      gallery: [
        ...
        "./workshop-6.jpg?height=400&width=600",
        "./workshop-7.jpg?height=400&width=600",
        "./workshop-9.jpg?height=400&width=600",
        "./workshop-11.jpg?height=400&width=600",
        "./workshop-12.jpg?height=400&width=600",
      ],
      materials: [
